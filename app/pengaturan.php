                                    ...
                                    if(!preg_match("/^[a-zA-Z0-9.,()\/ -]*$/", $alamat)){
                                        ...
                                        if(!preg_match("/^[a-zA-Z., ]*$/", $kepsek)){
                                            ...
                                            if(!preg_match("/^[0-9 +-]*$/", $nip)){
                                                $_SESSION['nipkepsek'] = 'Form NIP Kepala Instansi hanya boleh mengandung karakter angka, spasi, plus(+) dan minus(-)<br/><br/>';
                                                echo '<script language="javascript">window.history.back();</script>';
                                            } else {
                                ...
                                <div class="row">
                                    ...
                                    <div class="input-field col s6">
                                        ...
                                        <input id="institusi" type="text" class="validate" name="institusi" value="<?php echo $row['institusi']; ?>" required>
                                            ...
                                            ?>
                                        <label for="institusi">Nama Instansi</label>
                                    </div>
                                    <div class="input-field col s6">
                                    ...
                                    <div class="input-field col s6 tooltipped" data-position="top" data-tooltip="Jika tidak memiliki Nomer Telpon, isi dengan minus(-)">
