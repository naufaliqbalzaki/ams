                    ...
                    <div id="colres" class="warna cetak">
                        <table class="bordered" id="tbl" width="100%">
                            <thead class="blue lighten-4">
                                <tr>
                                <th width="50%" style="text-align: center;">No. Online<br/>Tanggal Daftar</th>
                                <th width="15%" style="text-align: center;">Nama Pemohon</th>
                                <th width="15%" style="text-align: center;">Sub Perizinan</th>
                                <th width="15%" style="text-align: center;">Dinas</th>
                                <th width="15%" style="text-align: center;">Keterangan</th>
                                <th width="15%" style="text-align: center;">Berkas Permohonan</th>
                                <th width="15%" style="text-align: center;">Verifikasi Petugas</th>
                                <th width="15%" style="text-align: center;">Catatan</th>
                                <th width="15%" style="text-align: center;">Nama Verifikasi</th>
                                <th width="15%" style="text-align: center;">No Telefon</th>
                                <th width="15%" style="text-align: center;">Jenis OPD</th>
                    ...
                    <div class="col s12">
                        <div class="z-depth-1">
                            ...
                            <div class="nav-wrapper" style="background-color: #2C559E;">
                                    <div class="col 12">
                                        <ul class="left">
                                            <li class="waves-effect waves-light"><a href="?page=ask" class="judul"><i class="material-icons">print</i> Cetak Agenda Kantor Pusat<a></li>
                                        </ul>
                                    </div>
                                </div>
                            </nav>
