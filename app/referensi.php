                    ...
                    <div class="col s12">
                        <div class="z-depth-1">
                            ...
                            <div class="nav-wrapper" style="background-color: #2C559E;">
                                    <div class="col m7">
                                        <ul class="left">
                                            <li class="waves-effect waves-light hide-on-small-only"><a href="?page=ref" class="judul"><i class="material-icons">class</i> Berkas Kantor Pusat</a></li>';
                    ...
                    <div class="col m12" id="colres">
                        <table class="bordered" id="tbl">
                            <thead class="blue lighten-4" id="head">
                                <tr>
                                    <th width="10%">No Online / Tanggal Daftar</th>
                                    <th width="20%">Nama Pemohon</th>
                                    <th width="30%">Perizinan</th>
                                    <th width="40%">Dinas</th>
                                    <th width="50%">Keterangan</th>
                                    <th width="60%">Berkas Pemohon Terakhir Klik Selesai</th>
                                    <th width="70%">Petugas UPTSA</th>
      ...
      if (mysqli_num_rows($query) > 0) {
        while ($row = mysqli_fetch_array($query)) {
          ...
          if ($_SESSION['admin'] != 1 and $_SESSION['admin'] != 2) {
            ...
            echo '<a class="btn small blue waves-effect waves-light" href="?page=ref&act=edit&id_surat=' . $row['id_surat'] . '">
                                                    <i class="material-icons">edit</i> EDIT</a>
                                                <a class="btn small deep-orange waves-effect waves-light" href="?page=ref&act=del&id_surat=' . $row['id_surat'] . '">
