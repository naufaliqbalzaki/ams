                    ...
                    <div class="col s12">
                        <div class="z-depth-1">
                            ...
                            <div class="nav-wrapper" style="background-color: #2C559E;">
                                    <div class="col m7">
                                        <ul class="left">
                                            <li class="waves-effect waves-light hide-on-small-only"><a href="?page=tsk" class="judul"><i class="material-icons">drafts</i> Kantor Timur</a></li>
        ...
        <table class="bordered" id="tbl">
            <thead class="blue lighten-4" id="head">
                <tr>
                    ...
                    <th style="text-align: center;">Verifikasi Petugas</th>
                    <th style="text-align: center;">Catatan</th>
                    <th style="text-align: center;">Nama Verifikasi</th>
                    <th style="text-align: center;">No Telefon</th>
                    <th style="text-align: center;">Jenis OPD</th>
