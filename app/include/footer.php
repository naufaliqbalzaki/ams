...
<footer class="page-footer">
    ...
    <div class="footer-copyright" style="background-color: #2C559E; color: white;">
            ...
            <span class="white-text">&copy; <?php echo date("Y"); ?>
                <?php
                    if(!empty($data['nama'])){
                        ...
                        echo 'DPM-PTSP Surabaya  &nbsp;|&nbsp; <a class="white-text" href="http://masrud.com" target="_blank">By M. Rudianto</a>';
                    }
                ?>
            </a>
            </span>
