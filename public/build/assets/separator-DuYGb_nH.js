import{r as i,j as p}from"./app-CKGnkuWl.js";import{_ as $,c as u}from"./button-rv4JaW_D.js";import{$ as m}from"./index-N1Jofh9g.js";const c="horizontal",v=["horizontal","vertical"],s=i.forwardRef((r,e)=>{const{decorative:t,orientation:o=c,...a}=r,n=f(o)?o:c,l=t?{role:"none"}:{"aria-orientation":n==="vertical"?n:void 0,role:"separator"};return i.createElement(m.div,$({"data-orientation":n},l,a,{ref:e}))});s.propTypes={orientation(r,e,t){const o=r[e],a=String(o);return o&&!f(o)?new Error(x(a,t)):null}};function x(r,e){return`Invalid prop \`orientation\` of value \`${r}\` supplied to \`${e}\`, expected one of:
  - horizontal
  - vertical
